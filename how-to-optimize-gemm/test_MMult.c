...
void cblas_gemm(int, int, int, double *, int, double *, int, double *, int);
void thread_gemm(int, int, int, double *, int, double *, int, double *, int);
void openmp_gemm(int, int, int, double *, int, double *, int, double *, int);
...
int main() {
  ...
  for (p = 0; p < 7; p++) {
    ...
    for (rep = 0; rep < NREPEATS; rep++) {
      ...
      dtime = dclock();
      cblas_gemm(m, n, k, a, lda, b, ldb, cold, ldc);
